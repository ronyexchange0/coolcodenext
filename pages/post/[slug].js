...
const Post = ({post, morePosts}) => {
    ...
    // const {title, image: {url}, content, description, meta: {metaDescription, tags}, slug} = post
    const {title, content, description, slug} = post
    ...
    return (
        <main className={styles.servicePage}>
            ...
            <motion.div className="container" exit={{opacity: 0}} initial="initial" animate={animation}>
                ...
                <HeadingLayout image={"/assets/images.png"} title={title}  style={{marginBottom: "60px"}}>
                    {description}
                </HeadingLayout>
                ...
                >
                    ...
                    <div className="col-1 align-self-center d-none d-xl-block">
                        <SocialShare/>
                    </div>
                    ...
                    <motion.div 
                    variants={fadeUp(1)} 
                    className={`${styles.content} col-xl-7 col-lg-7 text-center`}>
                    ...
                    <motion.div 
                    variants={fadeUp(1)} 
                    className={`${styles.content} align-self-center col-xl-4 col-lg-5 text-center`}>
                        {/* <LinksBox/> */}
